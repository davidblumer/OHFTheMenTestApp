...
@property (readwrite,nonatomic) float coverWidth;
@property (readwrite,nonatomic) float coverHeight;
...
- (id)initWithCoder:(NSCoder *)decoder {
    ...
    float width = [[decoder decodeObjectForKey:@"coverWidth"] floatValue];
    float height = [[decoder decodeObjectForKey:@"coverHeight"] floatValue];
